...
firebase.auth().onAuthStateChanged(function (user) {
    ...
    `;
            ...
            const invitedEmailInput =
                document.getElementById("invitedEmailInput");
            const invitedEmailButton =
                document.getElementById("invitedEmailButton");
            const invitedEmailType =
                document.getElementById("invitedEmailType");
            const createList = document.createElement("ul");
            const inviteEmailArea = document.querySelector(
                "#invited-eamil-area"
            );
